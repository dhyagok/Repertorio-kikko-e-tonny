...
const songs = [
  'Sorriso - eu topo',
  'ferrugem-pirata-tesouro',
  'pixote-nem-de-graça',
  'Dilsinho-Cansei-de-farra',
  'Dilsinho-pouco-a-pouco',
  'Felipe Araújo-atrasadinha',
  'Guga Nandes - Presentinho',
  'imagina- Pretexto',
]
...
function setProgress(e) {
  ...
  //
  let minutes = Math.floor(durationMusic / 100)
  let seconds = Math.floor(durationMusic % 100)
  end.textContent = `${minutes}:${(seconds =
    seconds < 10 ? '0' + seconds : seconds)}`

  let currentMinutes = Math.floor(currentTimeMusic / 100)
  let currentSecond = Math.floor(currentTimeMusic % 100)
